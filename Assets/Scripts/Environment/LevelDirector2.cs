...
public class LevelDirector2 : LevelDirectorBase
{
    private static LevelDirector2 _this;
    ...
    public static LevelDirector2 Instance
    {
        get
        {
            if (_this == null)
            {
                _this = FindObjectOfType<LevelDirector2>();
            }
